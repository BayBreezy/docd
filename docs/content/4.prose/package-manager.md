...
links:
  - title: Source Code
    href: https://github.com/BayBreezy/docd/blob/main/docd/app/components/content/ProsePmInstall.global.vue
...
### Nuxt + Docd Project Setup

::prose-callout{variant="example" title="Setting up a Nuxt + Docd Project"}
::
