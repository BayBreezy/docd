...
<script setup lang="ts">
   ...
   * @example
   * ```mdc
   * ::prose-code-snippet{file="/app/components/Button.vue" language="vue" title="Button Component"}
   * ::
   *
   * ::prose-code-snippet{url="https://example.com/code.js" language="javascript" start="10" offset="5"}
   * ::
   * ```
   */
